...
model = joblib.load(r"D:\Car_Dekho_Dataset\preprocessing\car_price_prediction_model.pkl")
label_encoders = joblib.load(r"D:\Car_Dekho_Dataset\preprocessing\label_encoders.pkl")
scalers = joblib.load(r"D:\Car_Dekho_Dataset\preprocessing\scalers.pkl")

# Load dataset for filtering and identifying similar data
data = pd.read_csv(r"D:\Car_Dekho_Dataset\structured\car_dheko_cleaned_dataset_raw.csv")
